...
rst=stmt.executeQuery("select productname,productprice,quantity,productid,vno from product where productname='"+pname+"' ");
  ...
  <form name="form1" id="form1" action="" method="get">
	...
	<input name="vno" type="hidden" value="<%= rst.getString(5) %>" />
	
  <table width="345" border="1" align="center">
    <tr>
      <td width="192"><div align="right">Product name </div></td>
      <td width="137"><input type="text" name="Productname" value="<%=rst.getString(1) %>" readonly="yes" required/></td>
    </tr>
    <tr>
      <td><div align="right">Product Price </div></td>
      <td><input type="text" name="ProductPrice" value="<%=rst.getString(2) %>" readonly="yes" required/></td>
    </tr>
    <tr>
      <td><div align="right">Available Quantity</div></td>
      <td>
      <input type="text" name="qty" value="<%=rst.getString(3) %>" readonly="yes" required /></td>
    </tr>
  ...
  <table width="568" border="1" align="center">
    ...
    <tr>
      ...
      <td><p align="right">card holder phone
        ...
        <input name="cardNum" type="text" id="cardNum" size="15"  required/>
</p>
      <p align="right">Enter CVV number
        <input name="cvv" type="text" id="cvv" size="3" required/>
</p>
<p align="right">Vender Number
         <input name="vnum" type="textt" readonly="true" value="<%= request.getParameter("vno") %>" />
</p>
  ...
  <%  
	...
	int x=stmt.executeUpdate("insert into orderlist (productname,productCast,quantity,totalAmount,address,cardHolderName,cardtype,cardNum,cvv,fno)values('"+t1+"','"+t2+"','"+t3 +"','"+t4+"','"+t5+"','"+t6+"','"+t7+"','"+t8+"','"+t9+"','"+vnum+"')");
	if(x!=0){
