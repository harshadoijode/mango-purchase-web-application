...
if(rst.next()){
session.setAttribute("cphone",s1);
session.setAttribute("cname",rst.getString(1));
session.setAttribute("cname",rst.getString(5));
%>
<script>
...
<%
 ...
 <div class="wrapper">
      ...
      <form action="" method="post">
        ...
        <div class="signup-link">Not a member? <a href="userReg.jsp">Signup now</a></div>
      </form>
    </div>
</center></td>
