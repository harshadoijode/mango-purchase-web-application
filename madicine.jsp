...
<%@ include file="db.jsp" %>
<div align="center" style="color:white; font-size:24px;"><strong>Madicine </strong></div>

<form  method="post" action="madicinecode.jsp"  enctype="multipart/form-data" >
...
<p align="center" style="color:#FFFFFF; font-size:18px;"> madicine Details </p>
...
try{
int x=stmt.executeUpdate("update madicine set name='"+request.getParameter("e1")+"',description='"+request.getParameter("e2")+"',price='"+request.getParameter("e3")+"' where name='"+request.getParameter("e1")+"' ");
if(x!=0)
{
...
try{
int x=stmt.executeUpdate("delete from madicine where name='"+request.getParameter("e1")+"'");
if(x!=0){
