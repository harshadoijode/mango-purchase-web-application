...
<%@ include file="db.jsp" %>
<div align="center" style="color:white; font-size:24px;"><strong>Add Fruit </strong></div>

<form  method="post" action="farmeraddfruitcode.jsp"  enctype="multipart/form-data" >
  <table bgcolor="grey" width="637" border="0" align="center" style="border-radius:20px">
    ...
    <tr>
      <td><div align="right"><span class="style1">price</span></div></td>
...
<table width="1076" border="0" align="center">
  ...
  rst=stmt.executeQuery("select * from fruit where farmernumber='"+session.getAttribute("fphone")+"'");
  while(rst.next()){
...
try{
int x=stmt.executeUpdate("update fruit set name='"+request.getParameter("e1")+"',description='"+request.getParameter("e2")+"',price='"+request.getParameter("e3")+"' where name='"+request.getParameter("e1")+"' ");
if(x!=0)
{
...
try{
int x=stmt.executeUpdate("delete from fruit where name='"+request.getParameter("e1")+"'");
if(x!=0){
