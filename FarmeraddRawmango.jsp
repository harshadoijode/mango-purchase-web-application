...
<%@ include file="db.jsp" %>
<div align="center" style="color:white; font-size:24px;"><strong>Add Raw Mango </strong></div>

<form  method="post" action="farmeraddRawmangoCode.jsp"  enctype="multipart/form-data" >
...
<table width="1076" border="0" align="center">
  ...
  rst=stmt.executeQuery("select * from rawmango where farmernumber='"+session.getAttribute("fphone")+"'");
  while(rst.next()){
