...
<%@ include file="db.jsp" %>
<% 
rst=stmt.executeQuery("select * from orderlist where fno='"+session.getAttribute("fphone")+"' ");
...
<table width="929" border="1" align="center">
  <tr bgcolor="#FFFFFF">
    ...
    <td width="146"><span class="style3">Order ID </span></td>
  ...
  <tr bgcolor="#CCFF99">
    ...
    <td><span class="style5">
      <input type="text" name="customerid"  value="<%= rst.getString(10) %>" readonly="true" />
    </span></td>
